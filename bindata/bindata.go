...
func templateAuthSwaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/auth.swagger.json", size: 2404, mode: os.FileMode(420), modTime: time.Unix(1505768040, 0)}
...
func templateUserSwaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/user.swagger.json", size: 6532, mode: os.FileMode(420), modTime: time.Unix(1505768040, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templateVpnSwaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/vpn.swagger.json", size: 3322, mode: os.FileMode(420), modTime: time.Unix(1505768040, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
