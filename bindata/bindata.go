...
func templateServerConfTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/server.conf.tmpl", size: 9595, mode: os.FileMode(420), modTime: time.Unix(1504004418, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
