...
func templateClientOvpnTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/client.ovpn.tmpl", size: 283, mode: os.FileMode(420), modTime: time.Unix(1502103574, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templateServerConfTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/server.conf.tmpl", size: 9585, mode: os.FileMode(420), modTime: time.Unix(1502130990, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
